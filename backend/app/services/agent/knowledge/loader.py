...
"""
    ...
    def validate_modules(self, module_names: List[str]) -> Dict[str, List[str]]:
        ...
        aliases = {
            ...
            "xxe": "xxe",
            # Solidity 别名
            "reentrancy": "solidity_reentrancy",
            "re-entrancy": "solidity_reentrancy",
            "overflow": "solidity_integer_overflow",
            "integer_overflow": "solidity_integer_overflow",
            "underflow": "solidity_integer_overflow",
            "oracle": "solidity_oracle_manipulation",
            "flash_loan": "solidity_oracle_manipulation",
            "flashloan": "solidity_oracle_manipulation",
            "signature_replay": "solidity_signature_replay",
            "replay": "solidity_signature_replay",
            "smart_contract": "solidity_reentrancy",
            "solidity": "solidity_reentrancy",
            # 新增 Solidity 别名
            "malleability": "solidity_signature_malleability",
            "signature_malleability": "solidity_signature_malleability",
            "proxy": "solidity_proxy_security",
            "upgradeable": "solidity_proxy_security",
            "storage_collision": "solidity_proxy_security",
            "precision": "solidity_precision_loss",
            "division": "solidity_precision_loss",
            "truncation": "solidity_precision_loss",
            "erc4626": "solidity_precision_loss",
            "mev": "solidity_front_running",
            "front_running": "solidity_front_running",
            "sandwich": "solidity_front_running",
            "slippage": "solidity_front_running",
            "crosschain": "solidity_crosschain_security",
            "cross_chain": "solidity_crosschain_security",
            "bridge": "solidity_crosschain_security",
            "layerzero": "solidity_crosschain_security",
            "erc20": "solidity_erc20_safety",
            "fee_on_transfer": "solidity_erc20_safety",
            "safeERC20": "solidity_erc20_safety",
            "amm": "solidity_amm_security",
            "uniswap": "solidity_amm_security",
            "liquidity": "solidity_amm_security",
