...
async def _save_findings(
    ...
    for finding in findings:
        ...
        try:
            ...
            if "reentr" in raw_type or "race" in raw_type:
                type_enum = VulnerabilityType.RACE_CONDITION
            if "delegatecall" in raw_type or "callcode" in raw_type or "selfdestruct" in raw_type:
                type_enum = VulnerabilityType.CODE_INJECTION
